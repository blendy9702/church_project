        ...
        <div className="flex flex-col justify-center items-center gap-5">
          <div className="flex justify-center items-center gap-5 mt-5">
            {statusData.map((item, index) => (
              <div
                key={index}
                className="bg-white/70 max-w-[230px] h-[70px] rounded-[12px] shadow-sm"
              >
                <div className="p-2">
          ...
          <div className="grid grid-cols-3 max-w-[980px] justify-center items-center gap-5">
          ...
          <div className="flex justify-center items-center gap-5">
            {chartData.map((item, index) => (
              <div
                key={index}
                className="bg-white/70 w-[230px] h-[400px] rounded-[12px] shadow-sm"
              >
                {index === 0 && (
                  <div className="">
                    <div className="flex justify-center items-center w-full">
          ...
          <div className="flex justify-center items-center gap-5 mb-5">
            <div className="bg-white/70 w-[480px] h-[230px] rounded-[12px] shadow-sm">
              <ShadcnChart />
            </div>
            <div className="bg-white/70 w-[480px] h-[230px] rounded-[12px] shadow-sm">
              <ShadcnChart />
